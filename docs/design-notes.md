# hintium — design notes

The full version of the README: every mode explained, with the measurements
and the reasoning behind each decision. [README.md](../README.md) is the
short version.
